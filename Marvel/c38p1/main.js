...
function check() {
    ...
    if(inp1.value === '1' && inp2.value === '6' && inp3.value === '4') 
    {
        document.getElementById('result').innerText = 'Right answer'
        button.classList.add("active")
        button.removeAttribute('disabled')

    }else if ((inp1.value === '1' && inp2.value === '6') || (inp3.value === '4' && inp1.value === '1') || (inp2.value === '6' && inp3.value === '4')) 
    {
        document.getElementById('result').innerText = 'Two are Correct'
    }
    else if (inp1.value === '1' || inp2.value === '6' || inp3.value === '4') 
    {
